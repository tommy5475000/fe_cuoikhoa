...
import { deleteUser, getUserList, searchUserList } from "../../../apis/user";

const columns = [
  { name: "Họ Tên", width: 120 },
  { name: "Email", width: 150 },
  { name: "Mật Khẩu", width: 100 },
  { name: "SĐT", width: 100 },
  { name: "Ngày Sinh", width: 100 },
  { name: "Role", width: 100 },
];
...
export default function AdminUser() {
  ...
  const { data } = useQuery({
    queryKey: ["getUserList", searchParams.get("page")],
    queryFn: () => getUserList(searchParams.get("page")),
  });
  ...
  const { data: dataSearch } = useQuery({
    queryKey: ["getDataSearch", searchTerm, searchParams.get("TenNguoiDung")],
    queryFn: () => searchUserList(searchTerm, searchParams.get("TenNguoiDung")),
  });
